...
public class GenericMethodsInGenericClassTwoParamsRunner {
    ...
    public static void main(String[] args) {
        ...
        GenericMethodsInGenericClassTwoParams<Aircraft, Copter> five = new GenericMethodsInGenericClassTwoParams<>();
        ...
        GenericMethodsInGenericClassTwoParams<Vegetalbe, Vertebrata> nineteen = new GenericMethodsInGenericClassTwoParams<>();
