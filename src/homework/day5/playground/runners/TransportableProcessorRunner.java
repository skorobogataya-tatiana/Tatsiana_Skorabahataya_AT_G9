...
public class TransportableProcessorRunner {
    ...
    public static void main(String[] args) {
        ...
        //Objects with type Flyable can not be used as input arguments, because Flyable doesn't implement Transportable interface and isn't part of its hierarchy
        ...
        //Objects with type Rideable can not be used as input arguments, because Rideable doesn't implement Transportable interface and isn't part of its hierarchy
        ...
        transportableProcessor.runTransportable(transportableCar, 23, 242);
